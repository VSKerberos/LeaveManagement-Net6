...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                LeaveTypes = new SelectList(_context.LeaveType, "Id", "Name")
        };
        ...
        public async Task<IActionResult> Create( LeaveRequestCreateVM model)
        {
            ...
            model.LeaveTypes = new SelectList(_context.LeaveType, "Id", "Name", model.LeaveTypeId);
            return View(model);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["LeaveTypeId"] = new SelectList(_context.LeaveType, "Id", "Id", leaveRequest.LeaveTypeId);
